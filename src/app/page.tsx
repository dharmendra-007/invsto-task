  ...
  return (
    <div>
      <div className="absolute top-0 left-0">
        ...
        <div className="bg-[url(/images/pattern-circles.svg)] bg-center h-50 bg-no-repeat translate-y-20 sm:translate-y-12 md:translate-y-24 text-[hsl(227,35%,25%)] flex justify-center flex-col font-man-rope gap-2">
